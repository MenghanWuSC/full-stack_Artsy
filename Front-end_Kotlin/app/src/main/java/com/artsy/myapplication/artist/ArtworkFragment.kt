...
import com.artsy.myapplication.databinding.FragmentArtworkBinding
...
class ArtworkFragment(
    ...
    override fun onCreateView(
        ...
        // . View Model: func
        // *Artsy API
        viewModel.getArtsyArtistArtworks(artistId)

        // . Data Binding
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_artwork, container, false)
